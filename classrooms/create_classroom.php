        ...
        <form action="create_classroom.php" method="POST" class="space-y-4">
            <div>
                ...
                <div class="flex items-center border border-red-300 rounded-md shadow-sm focus-within:border-red-500">
                    ...
                    <input type="text" id="room_number" name="room_number" placeholder="Enter Room Number" class="w-full px-4 py-2 border-0 focus:outline-none">
                </div>
            </div>
            <div class="mb-4">
                ...
                <div class="flex items-center border border-red-300 rounded-md shadow-sm focus-within:border-red-500">
                    ...
                    <input type="number" id="capacity" name="capacity" placeholder="Enter Capcity" class="w-full px-4 py-2 border-0 focus:outline-none">
                </div>
            </div>
            <div class="mb-4">
                ...
                <div class="flex items-center border border-red-300 rounded-md shadow-sm focus-within:border-red-500">
                    ...
                    <input type="text" id="building" name="building" placeholder="Enter Building Number" class="w-full px-4 py-2 border-0 focus:outline-none">
                </div>
            </div>

...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen">
        ...
        <div id="home" class="content-section hidden flex flex-col gap-4">
<!-- Flex container to align buttons on a single line -->
<div class="flex space-x-4 mb-4">
    <!-- Button to toggle the Enrollment Form iframe -->
    <button class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition duration-300" 
            onclick="toggleIframe('Enrollment Form', this)">Open Enrollment Form</button>

    <!-- Button to toggle the Select Course iframe -->
    <button class="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition duration-300" 
            onclick="toggleIframe('Select a Course', this)">Open Select Course</button>
</div>

<!-- Container for the Enrollment Form iframe -->
<div id="Enrollment Form" class="iframe-container hidden relative" style="height: 100vh; overflow-y:hidden">
    <!-- Close button positioned at the top right -->
    <button class="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 transition duration-300 absolute top-2 right-2" 
            onclick="closeIframe('Enrollment Form')">Close</button>
    <iframe src="enrollment_form.php" style="width: 100%; height: 100%; border: 0; margin: 0; padding: 0;"></iframe>
</div>

<!-- Container for the Select Course iframe -->
<div id="Select a Course" class="iframe-container hidden relative" style="height: 100vh;">
    <!-- Close button positioned at the top right -->
    <button class="bg-red-500 text-white py-2 px-4 rounded hover:bg-red-600 transition duration-300 absolute top-2 right-5" 
            onclick="closeIframe('Select a Course')">Close</button>
    <iframe src="select_course.php" style="width: 100%; height: 100%; border: 0; margin: 0; padding: 0;"></iframe>
</div>
...
function closeIframe(iframeId) {
    ...
    // Reset the related button text
    var button = document.querySelector("button[onclick*='" + iframeId + "']");
    button.innerText = 'Toggle ' + iframeId;
}

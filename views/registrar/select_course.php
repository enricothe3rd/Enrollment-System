...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['enroll'])) {
    ...
    // Process selected subjects (e.g., save to database, etc.)
    echo '<p class="text-green-500">You have selected the following subjects:</p>';
    echo '<ul>';
    foreach ($selected_subjects as $subject_id) {
        echo '<li>' . htmlspecialchars($subject_id) . '</li>'; // Replace with actual subject details
    }
    echo '</ul>';
}

...
<body class="bg-gray-100 p-6">
    ...
    <div class="max-w-4xl mx-auto bg-white p-8 shadow-md rounded-md">
        ...
        <form action="enroll.php" method="POST">
            ...
            <!-- Subjects and Schedules (Populated dynamically) -->
            <div id="subjectSchedule" class="mt-4">
                <!-- Subjects and schedules will be loaded here -->
            </div>

            <!-- Submit Button -->
            <div class="mt-6">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Enroll</button>
            </div>
        </form>
    </div>

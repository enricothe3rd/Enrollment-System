        ...
        <table class="w-full border-collapse  shadow-md rounded-lg">
            <thead class="bg-red-800">
                <tr>
                    ...
                    <th class="px-4 py-3 border-b text-left text-white">Name</th>
                    <th class="px-4 py-3 border-b text-left text-white">Established</th>
                    <th class="px-4 py-3 border-b text-left text-white">Dean</th>
                    <th class="px-4 py-3 border-b text-left text-white">Email</th>
                    <th class="px-4 py-3 border-b text-left text-white">Phone</th>
                    <th class="px-4 py-3 border-b text-left text-white">Location</th>
                    <th class="px-4 py-3 border-b text-left text-white">Faculty Count</th>
                    <th class="px-4 py-3 border-b text-left text-white">Student Count</th>
                    <th class="px-4 py-3 border-b text-left text-white">Actions</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="border-b bg-red-50 hover:bg-red-200">
                    ...
                    <td class="px-4 py-3"><?php echo htmlspecialchars($dept['established']); ?></td>

...
// Fetch courses, statuses, sexes, school years, and semesters for dropdowns
// Fetch School Years
$school_years_sql = "SELECT DISTINCT school_year FROM enrollment";
                    ...
                    <select id="school_year" name="school_year" class="w-full border border-gray-300 rounded-lg px-3 py-2" required>
                        ...
                        <?php foreach ($school_years as $year) : ?>
                            <option value="<?php echo htmlspecialchars($year['school_year']); ?>" 
                                <?php echo isset($enrollment_data['school_year']) && $enrollment_data['school_year'] == $year['school_year'] ? 'selected' : ''; ?>>
